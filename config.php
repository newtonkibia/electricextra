...
define("SITE_NAME", "electric extra");
...
define("APP_ID", "20c78426e9506a44e706421fedbb9769");
...
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['uusername'] : null ));
