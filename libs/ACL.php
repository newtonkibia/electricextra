	...
	public static $role_pages = array(
			'administrator' =>
						array(
							...
							'performance' => array('list','view','add','edit', 'editfield','delete'),
							'feature' => array('list','view','add','edit', 'editfield','delete'),
							'sidebar_features' => array('list','view','add','edit', 'editfield','delete')
						),
