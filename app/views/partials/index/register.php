                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-uusername"  value="<?php  echo $this->set_field_value('uusername',""); ?>" type="text" placeholder="Enter Uusername"  required="" name="uusername"  data-url="api/json/users_uusername_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
